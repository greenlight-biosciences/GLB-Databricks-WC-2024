...
class ImageProcessingAgent:
    ...
    def _planner(self, state: Dict):
        if state['plan_json']: system_msg = f"""As an expert in image processing, use the user's description: '{state['desc']}' to create or modify a JSON object that defines a sequence of filters. You may include any number of the available filters, repeating filters with different parameter values as needed, to achieve the desired outcome. Follow the advice of the critiquer from the previous messages if any. The current filter JSON is '{yaml.dump(state['plan_json'])}'. ** ALWAYS ANSWER IN THE JSON FORMAT PROVIDED, NO CONTENT SHOULD BE OUT OF THE JSON. Strictly adhere to the provided structure with no extra text or comments before or after the json. Your output should always start and end with curly braces **"""  + "\n{format_instructions}\n"
        else:
            system_msg = f"""As an expert in image processing, use the user's description: '{state['desc']}' to create or modify a JSON object that defines a sequence of filters. You may include any number of the available filters, repeating filters with different parameter values as needed, to achieve the desired outcome. Follow the advice of the critiquer from the previous messages if any. ** ALWAYS ANSWER IN THE JSON FORMAT PROVIDED, NO CONTENT SHOULD BE OUT OF THE JSON. Strictly adhere to the provided structure with no extra text or comments before or after the json. Your output should always start and end with curly braces **"""  + "\n{format_instructions}\n"
